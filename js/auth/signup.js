...
const inputValidationPassword = document.getElementById("ValidationPasswordInput");
...
function validateForm(){
   const nomOK = validateRequired(inputNom);
    ...
    const passwordValidationOK = validatePasswordConfirmation(inputPassword, inputValidationPassword);

    if(nomOK && prenomOK && emailOK && passwordOK && passwordValidationOK){
...
function validatePasswordConfirmation(passwordInput, validationInput){
    if(passwordInput.value == inputValidationPassword.value){
